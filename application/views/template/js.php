...
<!-- Select 2 -->
<script src="<?php echo base_url('assets/plugins/select2/4.0.4/js/select2.min.js')?>"></script>
...
<!-- Overhang -->
<script type="text/javascript" src="<?php echo base_url('assets/plugins/overhang/dist/overhang.min.js')?>"></script>
<!-- Jquery Block UI -->
<script src="<?php echo base_url('assets/plugins/blockui-master/jquery.blockUI.js') ?>"></script>
<!-- SweetAlert2 -->
<script src="<?php echo base_url('assets/plugins/sweetalert2/sweetalert2.min.js') ?>"></script>
<!-- Buatan sendiri js -->
<script> var base_url = "<?php echo base_url(); ?>";</script>
<script src="<?php echo base_url('assets/js/indikator.js') ?>"></script>
<script src="<?php echo base_url('assets/js/save.js') ?>"></script>
